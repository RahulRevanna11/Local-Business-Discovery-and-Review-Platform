...
const CitySearch = () => {
  ...
  return (
    <div className="container mt-8 w-full z-20">
      <div className="bg-white p-8 border border-gray-300 rounded-3xl shadow-md relative flex flex-col md:flex-row justify-between">
        <div className="mb-4 md:mb-0">
          <div className="flex items-center border-2 border-neutral-600 rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline rounded-xl text-[1.5rem]">
        ...
        <div className="mb-4 md:mb-0">
          <div className="flex items-center border-2 border-neutral-600 rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline rounded-xl">
            ...
            <input
              type="text"
              className="appearance-none text-xl font-bold border-none focus:outline-none w-full"
              placeholder="Enter something you're looking for"
              onChange={handleChange}
              value={keyword}
            />
          </div>
          {emptyError && <p className="text-red-400"><sup>*</sup>Please enter a keyword</p>}
        </div>

        <div>
          <button
            className="flex items-center gap-2 border-1 bg-green-600 p-2 rounded-lg"
            onClick={handleSubmit}
          >
            <p className="text-lg">Get Result</p>
