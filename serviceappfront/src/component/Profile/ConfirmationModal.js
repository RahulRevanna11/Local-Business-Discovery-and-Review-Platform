...
<div className=" mx-auto mt-8 p-6 bg-blue-300   shadow-md w-11/12 max-w-[350px] rounded-lg ">
      ...
      <div>
        ...
        <button className="block text-md font-medium text-gray-700 bg-pink-400 p-1  rounded-lg" onClick={()=>{setBookAppoinment(!bookAppoinment)
        setBookAppoinment({
          message: '',
          address: '',
          name: '',
      ...
      Book Appoinment
       ...
       { bookAppoinment&&<div>
          <label htmlFor="availableDate" className="block text-sm font-medium text-gray-700">Appoinment Date</label>
          <input
            type="date"
            id="availableDate"
            name="availableDate"
       ...
       {bookAppoinment&&<div>
          <label htmlFor="availableTime" className="block text-sm font-medium text-gray-700">Appoinment Time</label>
          <input
            type="text"
            id="availableTime"
            name="availableTime"
        ...
        <div className="flex justify-around gap-2">
         ...
         { !loading  &&<p>Inquire</p>}
        { loading&& <div className="spinner"></div>}</button>
          <button onClick={modalData.btn2Handler} className="w-full py-2 px-4 bg-pink-500 text-white rounded-md hover:bg-red-600 focus:outline-none focus:bg-red-600">cancle</button>
        </div>
      </form>
      </div>
    </div>
